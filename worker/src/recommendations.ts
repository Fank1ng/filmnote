...
export const REC_CACHE_VERSION = 'v4';
...
export async function loadRecommendations(env, entries, userId, blockedIds, excludeIds, blockedFeedback, options: RecommendationOptions = {}) {
...
export function makeRecKey(userId, entries, blockedIds, excludeIds, blockedFeedback, options: RecommendationOptions = {}) {
  const coupleMode = options.mode === 'couple' && !!options.partnerUserId;
